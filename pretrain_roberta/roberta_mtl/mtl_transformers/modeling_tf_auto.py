...
class TFAutoModel(object):
    r"""
        :class:`~mtl_transformers.TFAutoModel` is a generic model class
...
class TFAutoModelWithLMHead(object):
    r"""
        :class:`~mtl_transformers.TFAutoModelWithLMHead` is a generic model class
...
class TFAutoModelForSequenceClassification(object):
    r"""
        :class:`~mtl_transformers.TFAutoModelForSequenceClassification` is a generic model class
...
class TFAutoModelForQuestionAnswering(object):
    r"""
        :class:`~mtl_transformers.TFAutoModelForQuestionAnswering` is a generic model class
