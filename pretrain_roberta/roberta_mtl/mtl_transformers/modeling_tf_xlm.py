...
XLM_START_DOCSTRING = r"""    The XLM model was proposed in
    ...
    Parameters:
        config (:class:`~mtl_transformers.XLMConfig`): Model configuration class with all the parameters of the model.
...
XLM_INPUTS_DOCSTRING = r"""
    Inputs:
        **input_ids**: ```Numpy array`` or ``tf.Tensor`` of shape ``(batch_size, sequence_length)``:
            ...
            Indices can be obtained using :class:`mtl_transformers.XLMTokenizer`.
...
class TFXLMModel(TFXLMPreTrainedModel):
    ...
    Examples::
        ...
        import tensorflow as tf
        from mtl_transformers import XLMTokenizer, TFXLMModel
...
class TFXLMWithLMHeadModel(TFXLMPreTrainedModel):
    ...
    Examples::
        ...
        import tensorflow as tf
        from mtl_transformers import XLMTokenizer, TFXLMWithLMHeadModel
...
class TFXLMForSequenceClassification(TFXLMPreTrainedModel):
    ...
    Examples::
        ...
        import tensorflow as tf
        from mtl_transformers import XLMTokenizer, TFXLMForSequenceClassification
...
class TFXLMForQuestionAnsweringSimple(TFXLMPreTrainedModel):
    ...
    Examples::
        ...
        import tensorflow as tf
        from mtl_transformers import XLMTokenizer, TFXLMForQuestionAnsweringSimple
