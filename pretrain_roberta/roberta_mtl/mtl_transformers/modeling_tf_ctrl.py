...
CTRL_START_DOCSTRING = r"""    CTRL model was proposed in 
    ...
    Parameters:
        config (:class:`~mtl_transformers.CTRLConfig`): Model configuration class with all the parameters of the model.
...
CTRL_INPUTS_DOCSTRING = r"""    Inputs:
        **input_ids**: ``Numpy array`` or ``tf.Tensor`` of shape ``(batch_size, sequence_length)``:
            ...
            Indices can be obtained using :class:`mtl_transformers.CTRLTokenizer`.
...
class TFCTRLModel(TFCTRLPreTrainedModel):
    ...
    Examples::
        ...
        import tensorflow as tf
        from mtl_transformers import CTRLTokenizer, TFCTRLModel
...
class TFCTRLLMHeadModel(TFCTRLPreTrainedModel):
    ...
    Examples::
        ...
        import torch
        from mtl_transformers import CTRLTokenizer, TFCTRLLMHeadModel
