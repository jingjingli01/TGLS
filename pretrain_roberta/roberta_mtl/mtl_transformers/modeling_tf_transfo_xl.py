...
TRANSFO_XL_START_DOCSTRING = r"""    The Transformer-XL model was proposed in
    ...
    Parameters:
        config (:class:`~mtl_transformers.TransfoXLConfig`): Model configuration class with all the parameters of the model.
...
TRANSFO_XL_INPUTS_DOCSTRING = r"""
    Inputs:
        **input_ids**: ``Numpy array`` or ``tf.Tensor`` of shape ``(batch_size, sequence_length)``:
            ...
            Indices can be obtained using :class:`mtl_transformers.TransfoXLTokenizer`.
...
class TFTransfoXLModel(TFTransfoXLPreTrainedModel):
    ...
    Examples::
        ...
        import tensorflow as tf
        from mtl_transformers import TransfoXLTokenizer, TFTransfoXLModel
...
class TFTransfoXLLMHeadModel(TFTransfoXLPreTrainedModel):
    ...
    Examples::
        ...
        import tensorflow as tf
        from mtl_transformers import TransfoXLTokenizer, TFTransfoXLLMHeadModel
