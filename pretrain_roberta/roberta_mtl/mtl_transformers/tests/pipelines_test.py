...
class QuestionAnsweringPipelineTest(unittest.TestCase):
    ...
    @patch('mtl_transformers.pipelines.is_torch_available', return_value=False)
    ...
    @patch('mtl_transformers.pipelines.is_tf_available', return_value=False)
    @patch('mtl_transformers.tokenization_utils.is_tf_available', return_value=False)
