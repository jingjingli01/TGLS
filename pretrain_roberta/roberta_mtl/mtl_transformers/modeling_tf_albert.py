...
ALBERT_START_DOCSTRING = r"""    The ALBERT model was proposed in
    ...
    Parameters:
        config (:class:`~mtl_transformers.AlbertConfig`): Model configuration class with all the parameters of the model. 
...
ALBERT_INPUTS_DOCSTRING = r"""
    Inputs:
        **input_ids**: ``Numpy array`` or ``tf.Tensor`` of shape ``(batch_size, sequence_length)``:
            ...
            Indices can be obtained using :class:`mtl_transformers.AlbertTokenizer`.
...
class TFAlbertModel(TFAlbertPreTrainedModel):
    ...
    Examples::
        ...
        import tensorflow as tf
        from mtl_transformers import AlbertTokenizer, TFAlbertModel
...
class TFAlbertForMaskedLM(TFAlbertPreTrainedModel):
    ...
    Examples::
        ...
        import tensorflow as tf
        from mtl_transformers import AlbertTokenizer, TFAlbertForMaskedLM
...
class TFAlbertForSequenceClassification(TFAlbertPreTrainedModel):
    ...
    Examples::
        ...
        import tensorflow as tf
        from mtl_transformers import AlbertTokenizer, TFAlbertForSequenceClassification
