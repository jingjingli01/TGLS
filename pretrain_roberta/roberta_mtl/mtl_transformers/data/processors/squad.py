...
def squad_convert_examples_to_features(examples, tokenizer, max_seq_length,
    ...
    Args:
        examples: list of :class:`~mtl_transformers.data.processors.squad.SquadExample`
        tokenizer: an instance of a child of :class:`~mtl_transformers.PreTrainedTokenizer`
    ...
    Returns:
        list of :class:`~mtl_transformers.data.processors.squad.SquadFeatures`
...
class SquadProcessor(DataProcessor):
    ...
    def get_examples_from_dataset(self, dataset, evaluate=False):
        """
        Creates a list of :class:`~mtl_transformers.data.processors.squad.SquadExample` using a TFDS dataset.
...
class SquadFeatures(object):
    ...
    Those features are model-specific and can be crafted from :class:`~mtl_transformers.data.processors.squad.SquadExample`
    using the :method:`~mtl_transformers.data.processors.squad.squad_convert_examples_to_features` method.
