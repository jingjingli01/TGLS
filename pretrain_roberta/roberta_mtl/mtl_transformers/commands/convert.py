...
class ConvertCommand(BaseTransformersCLICommand):
    ...
    def __init__(self, model_type: str, tf_checkpoint: str, pytorch_dump_output: str,
        ...
        self._logger = getLogger('mtl_transformers-cli/converting')
    ...
    def run(self):
        if self._model_type == "bert":
            try:
                ...
                msg = "mtl_transformers can only be used from the commandline to convert TensorFlow models in PyTorch, " \
